<template>
  <div class="ui segments">
    <div class="ui segment">
      <div v-for="(item, index) in disks" v-bind:key="index" style="margin-top: 10px;">
        <a
        ...
        >
          <i class="icon" v-bind:class="{ remove: !item.mounted, disk: item.mounted }"></i>
          {{ item.name }}
        </a>
      </div>
    </div>
    ...
    <div class="ui segment blue" v-if="paths.length">
      ...
      <br />
      <div v-for="(item, index) in paths" v-bind:key="index" style="margin-top: 10px;">
